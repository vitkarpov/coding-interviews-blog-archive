...
* Проверяем точки в мапе и их счетчики:
* Возвращаем `True` если все считчики равны 0, кроме ровно 4 точек (для которых не нашлось пар) **и** координаты этих 4 точек совпадают с углами «большого» прямоугольника; 
